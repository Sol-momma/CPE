...
Forexample, togofrom(0;3)to(3;0)youhavetopasstwointermediatecircles(1;2)and(2;1). So,
...
lines each containing four integers (0 (cid:20) each_integer (cid:20) 100000) the first pair of which represents the
...
| Universidad | de Valladolid | OJ: 10642 | – Can You | Solve It? | 2/2 |
| ----------- | ------------- | --------- | --------- | --------- | --- |
| Sample      | Input         |           |           |           |     |
3
0 0 0 1
