...
mines within a M (cid:2) N field. To help you, the game shows a number in a square which tells you how
many mines there are adjacent to that square. For instance, supose the following 4 (cid:2) 4 field with 2
...
n and m (0 < n; m (cid:20) 100) which stands for the number of lines and columns of the field respectively.
...
Universidad de Valladolid OJ: 10189 – Minesweeper
