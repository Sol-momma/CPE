...
you must do k(cid:0)1 succesive divisions to reach n = 1). You can only have this sequence if the following
| restrictions | are      | met:                    |     |     |       |                |     |     |
| ------------ | -------- | ----------------------- | --- | --- | ----- | -------------- | --- | --- |
| • a[1]       | = n;a[i] | = a[i(cid:0)1](cid:4)m, |     | for | all 1 | < i (cid:20) k |     |     |
(cid:20)
