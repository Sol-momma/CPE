...
Consider three political parties. Assume h 1 = 3, h 2 = 4 and h 3 = 8 where h i is the hartal parameter
...
whichthesimulationmustberun. ThenextlinecontainsanotherintegerP (1 (cid:20) P (cid:20) 100)representing
the number of political parties in this case. The i th of the next P lines contains a positive integer h
i
(cid:20) (cid:20)
...
| Universidad | de Valladolid | OJ: 10050 | – Hartals | 2/2 |
| ----------- | ------------- | --------- | --------- | --- |
12
15
25
