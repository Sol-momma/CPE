...
8. The encryption is the result of M xor (b1 (cid:3) b2) : 265 xor (3*5) = 262
...
You have to write a program that read a N umber and give as output the number b1 and b2

Input

The first line will contain a number N which is the number of cases that you have to process. Each
of the following N Lines (0 < N (cid:20) 1000) will contain the number M (0 < M (cid:20) 9999, in decimal
