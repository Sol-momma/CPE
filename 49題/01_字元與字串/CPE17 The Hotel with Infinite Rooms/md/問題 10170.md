...
d) Averyimportantpropertyoftheincominggroupisthatithasonemorememberthanitsprevious
...
next group of five members will come on 5th August in the morning and stay for five days and so
on.
Given the initial group size you will have to find the group size staying in the hotel on a specified
day.
Input
|     |     | (cid:20) (cid:20) |     | (cid:20) 1015) |
| --- | --- | ----------------- | --- | -------------- |
The input contains round numbers S (1 S 10000) and D (1 D < in every line. S denotes
the initial size of the group and D denotes that you will have to find the group size staying in the hotel
on D-th day (starting from 1). All the input and output integers will be less than 1015. A group size S
