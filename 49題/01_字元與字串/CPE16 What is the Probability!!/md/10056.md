...
Input
Input will contain an integer S (S (cid:20) 1000) at first, which indicates how many sets of inputs are there.
(cid:20)
ThenextS lineswillcontainS setsofinputs. EachlinecontainanintegerN (N 1000)whichdenotes
