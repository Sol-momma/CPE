...
The input file contains 20 sets of inputs. Each set starts with two integers N (0 < N (cid:20) 10000) and
M (0 < M (cid:20) 10000) which denotes how many numbers are within this set. Each of the next N lines
...
Universidad de Valladolid OJ: 11321 – Sort! Sort!! And Sort!!!
